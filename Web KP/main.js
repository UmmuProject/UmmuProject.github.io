...
function handleFormSubmit() {
    ...
    reader.onload = function(event) {
        ...
        // Filter data to include only relevant columns and exclude specified Plant codes
        const filteredData = json
            .filter((row, index) => index === 0 || !['F239', 'F3BG', 'F3BT', 'F343'].includes(row[columnIndices[0]]))
        ...
        displayData();
        saveData(); // Save the data after updating dataStorage
